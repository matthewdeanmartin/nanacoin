...
def main():
    ...
    try:
        with sync_playwright() as p:
            ...
            open_draw = lotto.locator('article').filter(has=page.get_by_role('heading', name='Save and win interest', exact=True))
        ...
        server.shutdown()
        server.server_close()
    print('Static showcase passed: public routes, real browser health, notebook/font/mobile, economic indicators/help/mobile, voucher issue/print/redeem/replay; no API or external requests.')
